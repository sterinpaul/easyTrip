...
const ItinerarySchema = new mongoose.Schema(
  {
    ...
    guestCount: { adults: { type: Number, required: true }, children: { type: Number }, infants: { type: Number } },
    ...
    category: { type: String, enum: ["SINGLE", "FAMILY", "GROUP", "HONEYMOON"], required: true },
    type: { type: String, enum: ["ECONOMY", "STANDARD", "PREMIUM"], required: true },
